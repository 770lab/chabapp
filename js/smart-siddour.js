...
var TEFILOT = {
  ...
  mincha: {
    label: 'מִנְחָה', labelPhonetic: 'Min\'ha', labelFr: 'Priere de l\'apres-midi', sublabel: 'Mincha', icon: '☀️', image: 'assets/Its\'hak.png',
    sections: [
  ...
  arvit: {
    label: 'עַרְבִית', labelPhonetic: 'Arvit', labelFr: 'Priere du soir', sublabel: 'Arvit', icon: '🌙', image: 'assets/Yaakov.png',
    sections: [
